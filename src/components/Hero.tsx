...
function Hero() {
  ...
  return (
    <div className="dark:bg-black md:py-6 lg:py-2">
      <section className="container mx-auto px-5 pt-9 md:pt-12 lg:flex lg:pt-4">
        <div className="font-dm-sans py-4 lg:w-1/2 lg:self-center">
          <div className="text-center space-y-6 lg:text-left md:space-y-10 lg:space-y-7">
          ...
          "
            ...
            <div
              className="bg-grey flex space-x-2 text-base items-center shadow-inset justify-center md:space-x-7 p-4 rounded-lg w-fit 
            md:px-8 md:py-6
